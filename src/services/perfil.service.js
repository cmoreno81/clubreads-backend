...
export async function getPerfilUsuario(usuario) {
    ...
    const likesRecibidos = comentarios.reduce((total, comentario) => total + comentario.likes.length, 0);
