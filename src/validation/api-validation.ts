...
export const actionBodySchemas: Record<string, z.ZodType> = {
  ...
  anadirLibroExistente: body({ libro: identifierSchema, prioridad: prioritySchema, formato: formatSchema }),
  actualizarPreferenciasLibro: body({ libro: identifierSchema, prioridad: prioritySchema, formato: formatSchema }),
  ...
  crearLectura: body({ libro: identifierSchema, capitulos: positiveIntegerSchema, prologo: legacyBooleanSchema.optional(), epilogo: legacyBooleanSchema.optional(), paginas: pageSchema.optional(), tipo: readingTypeSchema.optional() }),
