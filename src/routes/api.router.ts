...
export async function handleApi(
  ...
  try {
    ...
    switch (action) {
      ...
      case 'librosGlobal':
        return handleLibrosGlobal(req, res);

      case 'librosFinalizadosTodosGlobal':
        return handleLibrosFinalizadosTodosGlobal(req, res);
      ...
      case 'actualizarValoracionLibro':
        return handleActualizarValoracionLibro(req, res);
      ...
      case 'ligaAcumulado':
        if (!req.auth) return requireAuthentication(req, res, () => {});
        return handleGetLigaAcumulado(req, res);
