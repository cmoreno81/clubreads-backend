...
const BOOK_ID_DEFINITIVO = 'cmrd84m4l00hiin50ru12ovuj';
const BOOK_ID_DUPLICADO = 'cmrd84m0j00ctin50kcttd5i2';

async function main() {
  console.log('🔎 Comprobando los libros...');
  ...
  const resultado = await prisma.$transaction(async (tx) => {
    ...
    const libroActualizado = await tx.book.update({
      ...
      data: {
        title: 'Todos los deseos que escribí sin ti',
